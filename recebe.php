...
if(isset($_POST['action']) && $_POST['action'] == 'senha'){
    ...
    //echo "<strong>Recuperação de senha</stron";
    ...
    if($resultado->num_rows > 0){
        ...
        $frase = "BatAtinh4Quando123456NAscexexeEsparr4ma4PeloChao4231";
    ...
    $url = verificar_entrada($_POST['urlImg']);
    ...
    if ($senha != $senhaC) {
        ...
        if ($linha['nomeUsuario'] == $nomeUsuario) {
            ...
            $sql = $conecta->prepare("INSERT into usuario (nome, nomeUsuario, email, senha, avatar, dataCriacao) values(?, ?, ?, ?, ?, ?)");
